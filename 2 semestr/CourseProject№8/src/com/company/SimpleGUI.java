...
public class SimpleGUI extends JFrame {
    ...
    private JRadioButton radio1 = new JRadioButton("Метод 1");
    private JRadioButton radio2 = new JRadioButton("Метод 2");
...
class ButtonEventListener implements ActionListener{
    public void actionPerformed(ActionEvent e) {
        ...
        colors = Coloring.coloring(matrix);
        JFrame frame = new JFrame("Результат работы программы:");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        GUIOut gui = new GUIOut();
